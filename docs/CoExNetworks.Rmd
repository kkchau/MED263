...
```
&copy; 2010 Allen Institute for Brain Science. BrainSpan Atlas of the Developing Human Brain. Available from: https://brainspan.org
...
for (fmod in list.files("/home/rstudio/work/modules", 
    ...
    members.as.symbols <- rowData(se.expr.filt)$gene_symbol[rowData(se.expr.filt)$ensembl_gene_id %in% module.members]
